...
public class BTreeObject implements Comparable<BTreeObject> {
	...
	public static int size = 16; //to indicate the size of data from BTreeObject in binary format, key value 8 bytes each
	/*
	...
	public int compareTo(BTreeObject o) { //compares two long keys 
		...
		//-1 if current obj key is less, 0 if keys are equal, 1 if current obj key is larger
	}
